...
public class BlackjackApp extends Application {
    ...
    private Parent createContent() {
        ...
        rightBG.setFill(Color.PURPLE);

        // LEFT
        VBox leftVBox = new VBox(50);
        leftVBox.setAlignment(Pos.TOP_CENTER);

        Text dealerScore = new Text("Dad Bot: ");
        Text playerScore = new Text("Humble CS Students: ");
        ...
        Text cashText = new Text(cashString);
        ...
        rightVBox.getChildren().addAll(bet, btnPlay, money, cashText, buttonsHBox);
        ...
        playerScore.textProperty().bind(new SimpleStringProperty("Humble CS Students: ").concat(player.valueProperty().asString()));
        dealerScore.textProperty().bind(new SimpleStringProperty("Dad Bot: ").concat(dealer.valueProperty().asString()));
